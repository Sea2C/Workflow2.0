(function ($, Backbone, dust, moment) {
    ...
    //End Appointment Template and Model
    ...
    var TaskViewModel = Task.extend({
        initialize: function (attributes) {
        }
    });

    var TaskListViewModel = Task.extend({
        initialize: function(attributes){
        }
    });

    var TaskListViewModelCollection = TaskCollection.extend({
    ...
    var TaskList = ModelListView.extend({
        collection: 'tasks',
        template: 'taskList',
        events: { 
            'click .edit': 'rowClick',
    ...
    // End Task Model and Router



    //User Templates and Models
    ...
    Templates.get({
        ...
        task: 'templates/tasks/view.dust',
        taskList: 'templates/tasks/list.dust'
