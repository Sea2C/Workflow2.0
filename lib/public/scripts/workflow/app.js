(function ($, Backbone, dust, moment) {
    ...
    Templates.get('appointment', 'templates/appointments/view.dust', function (template) {
        dust.loadSource(dust.compile(template, 'appointment'));

		Templates.get('appointmentList', 'templates/appointments/list.dust', function (template) {
			dust.loadSource(dust.compile(template, 'appointmentList'));
